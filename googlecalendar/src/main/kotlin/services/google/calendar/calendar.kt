...
data class ReservationProvider(
    ...
    @Transient val cachedListReservation = CachedMethod3Raw(this::listReservationImpl)
    ...
    @Transient val cachedAvailableDates = CachedMethod3Raw(this::availableDatesImpl)
